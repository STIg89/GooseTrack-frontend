...
import { Btn, LangSwitchWrapper, Input, Label } from './LangSwitcherSidebar.styled'
  ...
  return (
      ...
      <LangSwitchWrapper>
        ...
        <Btn checked={selectedLang === languages[0].code}>
          <Input type="radio" name='switcher' id='lang-2' onChange={handleLangChange} value={languages[0].code} checked={selectedLang === languages[0].code} />
